...
Config.ReturnDamage = false -- return visual damage when restoring vehicle from garage
...
Config.ReturnPayment = 450 -- a value to pay if vehicle is not in garage
...
Config.DefaultPlate = 'LEGACY' -- default plate being used to default_vehicles args
