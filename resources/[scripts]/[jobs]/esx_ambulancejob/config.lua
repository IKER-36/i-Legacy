...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		AmbulanceActions = {
			vector3(301.78, -598.90, 42.0)
		},

		Pharmacies = {
			vector3(230.1, -1366.1, -38.5) -- Disabled, using ox_inv pharmacy
		},

		Vehicles = {
			{
				Spawner = vector3(296.42, -601.96, -43.0),
				InsideShop = vector3(446.7, -1355.6, 43.5),
				Marker = {type = 36, x = 1.0, y = 1.0, z = 1.0, r = 100, g = 50, b = 200, a = 100, rotate = true},
				SpawnPoints = {
					{coords = vector3(292.72, -610.15, 43.3), heading = 227.6, radius = 4.0},
